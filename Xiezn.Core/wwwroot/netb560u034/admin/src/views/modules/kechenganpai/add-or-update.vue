<template>
	<div class="addEdit-block" :style='{"minHeight":"100vh","padding":"30px 30px 30px 0","fontSize":"14px","color":"#666","background":"#f4f8fb"}'>
		...
		>
			<template >
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 20px 0","color":"inherit","borderRadius":"0px","display":"inline-block","width":"100%","fontSize":"inherit"}' class="input" v-if="type!='info'" label="安排编号" prop="anpaibianhao">
					<el-input v-model="ruleForm.anpaibianhao" placeholder="安排编号" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 20px 0","color":"inherit","borderRadius":"0px","display":"inline-block","width":"100%","fontSize":"inherit"}' class="input" v-else-if="ruleForm.anpaibianhao" label="安排编号" prop="anpaibianhao">
					<el-input v-model="ruleForm.anpaibianhao" placeholder="安排编号" readonly></el-input>
				</el-form-item>
				...
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 20px 0","color":"inherit","borderRadius":"0px","display":"inline-block","width":"100%","fontSize":"inherit"}' class="input" v-if="type!='info'"  label="上课时间" prop="shangkeshijian">
					<el-input v-model="ruleForm.shangkeshijian" placeholder="上课时间" clearable  :readonly="ro.shangkeshijian"></el-input>
				</el-form-item>
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 20px 0","color":"inherit","borderRadius":"0px","display":"inline-block","width":"100%","fontSize":"inherit"}' v-else class="input" label="上课时间" prop="shangkeshijian">
					<el-input v-model="ruleForm.shangkeshijian" placeholder="上课时间" readonly></el-input>
				</el-form-item>
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 20px 0","color":"inherit","borderRadius":"0px","display":"inline-block","width":"100%","fontSize":"inherit"}' class="select" v-if="type!='info'" label="学号" prop="xuehao">
				...
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 20px 0","color":"inherit","borderRadius":"0px","display":"inline-block","width":"100%","fontSize":"inherit"}' class="input" v-else-if="ruleForm.xuehao" label="学号" prop="xuehao">
				...
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 20px 0","color":"inherit","borderRadius":"0px","display":"inline-block","width":"100%","fontSize":"inherit"}' class="date" v-if="type!='info'" label="安排时间" prop="anpaishijian">
					<el-date-picker
				...
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 20px 0","color":"inherit","borderRadius":"0px","display":"inline-block","width":"100%","fontSize":"inherit"}' class="input" v-else-if="ruleForm.anpaishijian" label="安排时间" prop="anpaishijian">
					<el-input v-model="ruleForm.anpaishijian" placeholder="安排时间" readonly></el-input>
				</el-form-item>
			</template>
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 20px 0","color":"inherit","borderRadius":"0px","display":"inline-block","width":"100%","fontSize":"inherit"}' class="textarea" v-if="type!='info'" label="安排内容" prop="anpaineirong">
					<el-input
					  style="min-width: 200px; max-width: 600px;"
					  type="textarea"
					  :rows="8"
					  placeholder="安排内容"
					  v-model="ruleForm.anpaineirong" >
					</el-input>
				</el-form-item>
				<el-form-item :style='{"border":"0px solid #eee","padding":"0","margin":"0 0 20px 0","color":"inherit","borderRadius":"0px","display":"inline-block","width":"100%","fontSize":"inherit"}' v-else-if="ruleForm.anpaineirong" label="安排内容" prop="anpaineirong">
					<span :style='{"fontSize":"14px","lineHeight":"40px","minWidth":"1000px","color":"inherit","fontWeight":"500","display":"inline-block"}'>{{ruleForm.anpaineirong}}</span>
				</el-form-item>
...
export default {
		...
		init(id,type) {
			...
			if(this.type=='info'||this.type=='else'){
				...
				for (var o in obj){
						...
						if(o=='anpaineirong'){
							this.ruleForm.anpaineirong = obj[o];
							this.ro.anpaineirong = true;
							continue;
						}
				}
			}
    ...
    // 提交
    onSubmit() {
		if(this.ruleForm.anpaibianhao) {
			this.ruleForm.anpaibianhao = String(this.ruleForm.anpaibianhao)
		}
