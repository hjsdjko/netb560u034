				...
				@selection-change="selectionChangeHandler">
					...
					<el-table-column width="300" label="操作">
						<template slot-scope="scope">
							...
							<el-button class="btn8" v-if="isAuth('zuoyexinxi','立即提交')" @click="xueshengzuoyeCrossAddOrUpdateHandler(scope.row,'cross','','','','')" type="success">
...
import xueshengzuoyeCrossAddOrUpdate from "../xueshengzuoye/add-or-update";
	export default {
		...
		methods: {
			...
			xueshengzuoyeCrossAddOrUpdateHandler(row,type,crossOptAudit,crossOptPay,statusColumnName,tips,statusColumnValue){
				this.showFlag = false;
